...
lazy val dependencies = new {
  ...
  val alpakkaPubSub = "com.lightbend.akka" %% "akka-stream-alpakka-google-cloud-pub-sub" % alpakkaV
  val alpakkaGC = "com.lightbend.akka" %% "akka-stream-alpakka-google-cloud-storage" % alpakkaV
